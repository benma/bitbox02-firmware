...
class BTCScriptConfig(google.protobuf.message.Message):
    ...
    class Descriptor(google.protobuf.message.Message):
        ...
        class Key(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor
            KEY_ORIGIN_INFO_FIELD_NUMBER: builtins.int
            @property
            def key_origin_info(self) -> common_pb2.KeyOriginInfo: ...
            def __init__(self,
                *,
                key_origin_info: typing.Optional[common_pb2.KeyOriginInfo] = ...,
                ) -> None: ...
            def HasField(self, field_name: typing_extensions.Literal["key",b"key","key_origin_info",b"key_origin_info"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["key",b"key","key_origin_info",b"key_origin_info"]) -> None: ...
            def WhichOneof(self, oneof_group: typing_extensions.Literal["key",b"key"]) -> typing.Optional[typing_extensions.Literal["key_origin_info"]]: ...
    ...
    @property
    def descriptor(self) -> global___BTCScriptConfig.Descriptor: ...
    def __init__(self,
        *,
        simple_type: global___BTCScriptConfig.SimpleType.ValueType = ...,
        multisig: typing.Optional[global___BTCScriptConfig.Multisig] = ...,
        descriptor: typing.Optional[global___BTCScriptConfig.Descriptor] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["config",b"config","descriptor",b"descriptor","multisig",b"multisig","simple_type",b"simple_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["config",b"config","descriptor",b"descriptor","multisig",b"multisig","simple_type",b"simple_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["config",b"config"]) -> typing.Optional[typing_extensions.Literal["simple_type","multisig","descriptor"]]: ...
