...
pub struct BitBoxBaseHeartbeatRequest {
    ...
    pub state_code: i32,
    #[prost(
        enumeration = "bit_box_base_heartbeat_request::DescriptionCode",
        tag = "2"
    )]
...
pub struct BitBoxBaseSetConfigRequest {
    #[prost(
        enumeration = "bit_box_base_set_config_request::StatusLedMode",
        tag = "1"
    )]
    pub status_led_mode: i32,
    #[prost(
        enumeration = "bit_box_base_set_config_request::StatusScreenMode",
        tag = "2"
    )]
