...
const ALLOWED_HASH: &[u8; 32] = b"\xb8\x32\xff\x2b\xca\x95\xc3\xef\xee\x6b\xfc\x5c\x3b\xea\x4c\xd0\xe4\x8b\xf4\x0d\x55\xad\xd9\x90\x3a\xc2\xcc\x53\x47\xc8\xb9\x33";
...
async fn process_upgrade(
    ...
    if response.is_ok() {
        ...
        bitbox02::reset_ble();
        if bitbox02::communicating_via_ble() {
