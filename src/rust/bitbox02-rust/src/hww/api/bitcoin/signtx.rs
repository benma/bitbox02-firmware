...
mod tests {
        ...
        *crate::hww::MOCK_NEXT_REQUEST.0.borrow_mut() = None;
...

        {
            ...
            let multisig = pb::btc_script_config::Multisig {
                threshold: 1,
                xpubs: vec![
                    crate::keystore::get_xpub_once(&mut hal, keypath)
                        .unwrap()
                        .into(),
            ...
            {
                let mut hal = TestingHal::new();
                assert!(super::super::multisig::validate(&mut hal, &multisig, keypath).is_ok());
            }
    ...
    fn test_policy() {
        ...
        *crate::hww::MOCK_NEXT_REQUEST.0.borrow_mut() =
        ...
        let mut key_hal = TestingHal::new();
        let policy = pb::btc_script_config::Policy {
            ...
            keys: vec![
                pb::KeyOriginInfo {
                    ...
                    keypath: keypath_account.to_vec(),
                    xpub: Some(
                        crate::keystore::get_xpub_once(&mut key_hal, keypath_account)
                            .unwrap()
                            .into(),
                    ),
                },
