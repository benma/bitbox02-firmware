...
static void _render(component_t* component)
{
    ...
    snprintf(
        ...
        sizeof(text),
        "%d/%d %d/%d\n%d/%d %d/%d",
        qtouch_get_sensor_node_signal(4), qtouch_get_sensor_node_reference(0),
        qtouch_get_sensor_node_signal(5), qtouch_get_sensor_node_reference(1),
        qtouch_get_sensor_node_signal(6), qtouch_get_sensor_node_reference(2),
        qtouch_get_sensor_node_signal(7), qtouch_get_sensor_node_reference(3));
    label_update(data->label_top, text);
    snprintf(
        text,
        sizeof(text),
        "%d/%d %d/%d\n%d/%d %d/%d",
        qtouch_get_sensor_node_signal(3), qtouch_get_sensor_node_reference(7),
        qtouch_get_sensor_node_signal(2), qtouch_get_sensor_node_reference(6),
        qtouch_get_sensor_node_signal(1), qtouch_get_sensor_node_reference(5),
        qtouch_get_sensor_node_signal(0), qtouch_get_sensor_node_reference(4));
...
component_t* sensors_create(void (*done_callback)(bool, void*), void* cb_param)
{
    ...
    data->label_top = label_create("label", &font_font_a_9X9, LEFT_TOP, orientation);
    ui_util_add_sub_component(orientation, data->label_top);
    data->label_bottom = label_create("label", &font_font_a_9X9, LEFT_BOTTOM, orientation);
