    ...
    void* callback_param)
{
    ...
    if (params->scrollable) {
        ui_util_add_sub_component(
            confirm, label_create_scrollable_offset(params->body, params->font, CENTER, 0, yoffset, confirm));
    } else {
        ui_util_add_sub_component(confirm, label_create_offset(params->body, params->font, CENTER, 0, yoffset, confirm));
    }
