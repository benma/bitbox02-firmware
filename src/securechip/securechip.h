 ...
 * @return For ATECC: values of `atecc_error_t` if negative, values of `ATCA_STATUS` if positive, 0 on
 * success. For Optiga: valus of `optiga_error_t` if negative, values of optiga_lib_return_codes.h
 * if positive, 0 on success.
 */
