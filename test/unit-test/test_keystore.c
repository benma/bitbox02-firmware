...
static void _test_keystore_secp256k1_schnorr_bip86_sign(void** state)
{
    _mock_with_mnemonic(
        ...
        "about",
        "");
    // From the first test vector at:
    // https://github.com/bitcoin/bips/blob/85cda4e225b4d5fd7aff403f69d827f23f6afbbc/bip-0086.mediawiki#test-vectors
    uint8_t pubkey[32] =
        "\xa6\x08\x69\xf0\xdb\xcf\x1d\xc6\x59\xc9\xce\xcb\xaf\x80\x50\x13\x5e\xa9\xe8\xcd\xc4\x87"
        "\x05\x3f\x1d\xc6\x88\x09\x49\xdc\x68\x4c";
